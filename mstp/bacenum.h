/*####COPYRIGHTBEGIN####
 ...
 Modified by Kåre Särs (kare.sars@wapice.com) 2005
 -------------------------------------------
####COPYRIGHTEND####*/
#ifndef BACENUM_H
#define BACENUM_H
...
#define BACNET_LAST_STAT_FLAG_BIT STATUS_FLAG_OUT_OF_SERVICE

#define BACNET_LAST_STAT_BSTR_LEN ((BACNET_LAST_STAT_FLAG_BIT / 8) + 1)
...
typedef enum
{
    ...
    UNITS_AMPERES_SQUARE_METER = 169,
    UNITS_FARADS = 170,
    UNITS_HENRYS = 171,
    UNITS_OHMS =  4,
    ...
    UNITS_MINUTE = 72,
    UNITS_SECOND = 73,
    UNITS_HUNDREDTHS_SECOND = 158,
    UNITS_MILLISECOND = 159,
    /* Torque */
    UNITS_NEWTON_METER = 160,
    /*Velocity */
...
#error BACNET_PROTOCOL_REVISION not defined
#else
#define BACNET_LAST_OBJ_SUPP_BIT OBJECT_PULSE_CONVERTER
#endif

#define BACNET_OBJ_SUPP_BSTR_LEN ((BACNET_LAST_OBJ_SUPP_BIT / 8) + 1)
...
/* The following is copied directly from vts-3.4.7-source */
...
#define BACNET_LAST_SERV_SUPP_BIT asGetEventInformation
